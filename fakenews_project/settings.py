...
# Jazzmin Admin
JAZZMIN_SETTINGS = {
    "site_title": "FakeNews AI Admin",
    "site_header": "FakeNews AI",
    "site_brand": "FakeNews AI",
    "welcome_sign": "Welcome to FakeNews AI Admin",
    "copyright": "FakeNews AI Detection System",
    "show_sidebar": True,
    "navigation_expanded": True,
    "hide_apps": [],
    "hide_models": [],
    "order_with_respect_to": ["accounts", "detector"],
    "icons": {
        "auth": "fas fa-users-cog",
        "auth.user": "fas fa-user",
        "auth.Group": "fas fa-users",
        "detector.Analysis": "fas fa-search",
    },
